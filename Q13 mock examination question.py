Companies = ["Company1", "Company2", "Company3"]  # Replace with actual company names
StockPrices = [
    [10, 98, 95, 110, 120, 130, 90],  # Example prices for Company1
...
if index == -1:
    ...
    sell_day = 1  # Initialise sell day to 1 to ensure a valid sale happens after the buy day  # Initialise the best sell day
